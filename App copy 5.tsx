...
现在请开始你的分析：`
      ...
      const [aiResponse, contrastPrompt] = await Promise.all([
        ...
        generateContrastPromptByAI(analysis, metaphorType)
      ])
...
<div class="space-y-6 text-gray-700">
  ...
  ${analysis.table_understanding ? renderTableUnderstanding(analysis) : ''}
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            {((uploadMode === 'single' && uploadedFile) ||
              (uploadMode === 'dual' && uploadedFileA && uploadedFileB) ||
              showDemo) &&
              activeStep < 3 && (
                <button
                  onClick={analyzeData}
