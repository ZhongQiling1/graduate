...
请返回JSON格式：
{
  "industry": "电商|金融|医疗|教育|科技|制造|零售|其他",
  "industry_details": {
    "main_category": "主要分类",
    "sub_category": "子分类",
    "confidence": 0.85
  ...
  "entity_keywords": {
    "primary_object": "最合适的核心物体（如：金币、建筑、球体等）",
...
3. 颜色方案要符合行业特征`
      ...
      messages: [
        {
          role: 'system',
          content:
            '你是一个数据分析专家，擅长识别数据所属的行业领域，并为视觉化提取合适的实体关键词。'
        },
        {
          role: 'user',
          content: prompt
  ...
  return {
    ...
    metaphor_suggestions: {
      physical_collections: '金币堆',
      construction_progress: '仓库建设',
      density_distribution: '订单分布点'
    }
  }
}
